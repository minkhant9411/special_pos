<template>
    ...
    <Head>
        <title>| Sale Board</title>
    </Head>

    <NormalNav :name="!showCart ? 'Create Board' : 'Board Cart'" url="home" :hasDark="false" :back="!showCart">
...
const allItems = ref(JSON.parse(localStorage.getItem('board-cart') || '[]'));
...
const AddItem = () => {
    ...
    localStorage.setItem('board-cart', JSON.stringify(allItems.value))
