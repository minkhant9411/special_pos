<template>
    <button
        type="button"
        @click="toggleTheme"
        class="text-gray-500 cursor-pointer dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-sm p-2.5"
    >
        <!-- Dark Icon (visible when light mode is active) -->
        <svg
            v-show="!isDark"
            class="w-5 h-5"
            fill="currentColor"
        ...
        <!-- Light Icon (visible when dark mode is active) -->
        <svg
            v-show="isDark"
            class="w-5 h-5"
            fill="currentColor"
        ...
        >
          ...
          011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05
