<template>
    <div
        class="bg-gray-100 dark:bg-gray-800 h-[100vh] w-[100vw] flex justify-center items-center"
    >
        <form
        ...
        >
            ...
            <div class="mb-6 relative">
                ...
                />
                <span
                    class="absolute inset-y-0 end-2 flex items-center ps-3.5 cursor-pointer"
                    ><svg
                        v-if="type === 'password'"
                        @click="type = 'text'"
